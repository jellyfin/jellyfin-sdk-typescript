...
* The `Api` class now contains a `webSocket` field, of which `OutboundWebSocketMessageType`s can be subscribed to for receiving WebSocket messages [#966](https://github.com/jellyfin/jellyfin-sdk-typescript/issues/966).
