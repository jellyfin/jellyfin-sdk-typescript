...
• `Const` **HTTPS\_PORT**: ``443``

The default port for the https protocol.

#### Defined in

[utils/url.ts:19](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/url.ts#L19)

___

### HTTPS\_PROTOCOL

• `Const` **HTTPS\_PROTOCOL**: ``"https:"``

The https protocol string.

#### Defined in

[utils/url.ts:13](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/url.ts#L13)
...
[utils/url.ts:16](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/url.ts#L16)

___

### HTTP\_PROTOCOL

• `Const` **HTTP\_PROTOCOL**: ``"http:"``

The http protocol string.

#### Defined in

[utils/url.ts:10](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/url.ts#L10)

___

### JF\_HTTPS\_PORT

• `Const` **JF\_HTTPS\_PORT**: ``8920``

The default https port for Jellyfin servers.

#### Defined in

[utils/address-candidates.ts:13](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/address-candidates.ts#L13)

___

### JF\_HTTP\_PORT

• `Const` **JF\_HTTP\_PORT**: ``8096``

The default http port for Jellyfin servers.

#### Defined in

[utils/address-candidates.ts:10](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/address-candidates.ts#L10)
...
[utils/url.ts:26](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/url.ts#L26)
...
[utils/address-candidates.ts:52](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/address-candidates.ts#L52)
...
[utils/authentication.ts:11](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/authentication.ts#L11)

___

### getBrowserDeviceProfile

▸ **getBrowserDeviceProfile**(`options?`, `videoElement?`): [`DeviceProfile`](../interfaces/generated_client.DeviceProfile.md)
...
[utils/browser-profiles.ts:58](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/browser-profiles.ts#L58)
...
[utils/url.ts:35](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/url.ts#L35)
...
[utils/url.ts:46](https://github.com/jellyfin/jellyfin-sdk-typescript/blob/fa599ae/src/utils/url.ts#L46)
