...
export const YearsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getYear(requestParameters: YearsApiGetYearRequest, options?: AxiosRequestConfig): AxiosPromise<BaseItemDto> {
         ...
         * @throws {RequiredError}
         */
        getYears(requestParameters: YearsApiGetYearsRequest = {}, options?: AxiosRequestConfig): AxiosPromise<BaseItemDtoQueryResult> {
