...
export const StudiosApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getStudio(requestParameters: StudiosApiGetStudioRequest, options?: AxiosRequestConfig): AxiosPromise<BaseItemDto> {
         ...
         * @throws {RequiredError}
         */
        getStudios(requestParameters: StudiosApiGetStudiosRequest = {}, options?: AxiosRequestConfig): AxiosPromise<BaseItemDtoQueryResult> {
