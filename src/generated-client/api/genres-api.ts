...
export const GenresApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getGenre(requestParameters: GenresApiGetGenreRequest, options?: AxiosRequestConfig): AxiosPromise<BaseItemDto> {
         ...
         * @throws {RequiredError}
         */
        getGenres(requestParameters: GenresApiGetGenresRequest = {}, options?: AxiosRequestConfig): AxiosPromise<BaseItemDtoQueryResult> {
